...
def parse_transcript(input_string):
    """
    Parses a formatted string and extracts the text as a list.
    Ignores lines that don't have the [n] format.
    :param input_string: The input string to parse.
    :return: List of extracted text or raises an error if no valid lines are found.
    """
